# Makefile for minio-file package
...
test-coverage:  ## Run tests with coverage report
	pytest tests/ --cov=minio_file --cov-report=html --cov-report=term-missing
...
lint:  ## Run all linting tools
	...
	flake8 src/ tests/
	# mypy src/minio_file/ || echo "⚠️  mypy check completed with issues"
